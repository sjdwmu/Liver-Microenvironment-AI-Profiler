...
CONFIG = {
    'PATHS': {
        'Liver biopsy': r'E:\sjd\match\Patches_Normalized\Liver biopsy',
        'Liver transplantation': r'E:\sjd\match\Patches_Normalized\Liver transplantation'
    },
    'MODEL_PATH': r"E:\sjd\match\Models\best_convnext_tiny_10class.pth",
    'OUTPUT_CSV': r"E:\sjd\match\WSI_Tissue_Composition.csv",
    'NUM_CLASSES': 10,
    'BATCH_SIZE': 128,
...
def main():
    ...
    for group_name, group_dir in CONFIG['PATHS'].items():
        ...
        for wsi_folder in tqdm(wsi_folders):
            ...
            for i in range(CONFIG['NUM_CLASSES']):
                row[f'Class_{i}_Count'] = class_counts[i]
                row[f'Class_{i}_Ratio'] = class_counts[i] / total_patches if total_patches > 0 else 0
